...
var wpServerlessSearch = (function () {
    ...
    function postContent(
      ...
      <div class="post-thumbnail">
        <img src="` + postContentData.thumbnail + `" alt="` + postContentData.title + `" loading="lazy">
      </div>
      <div class='post-content'>
        <h2 class='title'><a href='` + postContentData.link + `' rel='bookmark'>` + postContentData.title + `</a></h2>
        <span class='excerpt'>` + postContentData.excerpt.substr(0, 200) + `...</span>
      </div>
    </article>`;
    }
